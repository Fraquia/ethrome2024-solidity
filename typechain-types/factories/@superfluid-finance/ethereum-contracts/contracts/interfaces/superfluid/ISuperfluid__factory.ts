...
export class ISuperfluid__factory {
  ...
  static createInterface(): ISuperfluidInterface {
    return new Interface(_abi) as ISuperfluidInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ISuperfluid {
    return new Contract(address, _abi, runner) as unknown as ISuperfluid;
  }
}
