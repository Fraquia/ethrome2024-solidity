...
export class ISuperToken__factory {
  ...
  static createInterface(): ISuperTokenInterface {
    return new Interface(_abi) as ISuperTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ISuperToken {
    return new Contract(address, _abi, runner) as unknown as ISuperToken;
  }
}
