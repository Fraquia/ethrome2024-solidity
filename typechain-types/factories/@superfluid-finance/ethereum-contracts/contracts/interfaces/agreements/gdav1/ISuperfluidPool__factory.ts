...
export class ISuperfluidPool__factory {
  static readonly abi = _abi;
  static createInterface(): ISuperfluidPoolInterface {
    return new Interface(_abi) as ISuperfluidPoolInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISuperfluidPool {
    return new Contract(address, _abi, runner) as unknown as ISuperfluidPool;
  }
}
