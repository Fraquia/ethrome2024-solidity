...
export interface ISETHInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "POOL_ADMIN_NFT"
      | "POOL_MEMBER_NFT"
  ...
  encodeFunctionData(
    functionFragment: "operationDowngradeTo",
    values: [AddressLike, AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "operationUpgradeTo",
    values: [AddressLike, AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ISETH extends BaseContract {
  connect(runner?: ContractRunner | null): ISETH;
  waitForDeployment(): Promise<this>;

  interface: ISETHInterface;
  ...
  operationDowngradeTo: TypedContractMethod<
    [account: AddressLike, to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  operationUpgradeTo: TypedContractMethod<
    [account: AddressLike, to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "operationDowngradeTo"
  ): TypedContractMethod<
    [account: AddressLike, to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "operationUpgradeTo"
  ): TypedContractMethod<
    [account: AddressLike, to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
